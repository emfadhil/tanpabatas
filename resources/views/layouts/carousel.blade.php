    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background-repeat: no-repeat; background: url( {{asset('img/slide/slide-2.jpg') }}">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animated fadeInDown">Ayo Gabung Bersama Kami di <span>TanpaBatas</span></h2>
                <h5 class="animated fadeInUp">Layanan informasi tentang fasilitas disabilitas yang ada di sekitar kita</h5>
